...
<footer class=" page-footer responsive-utilities-test font-small blue pt-4">
    ...
    <div style="background-color: #333" class="footerO container-fluid text-center text-md-left">
        ...
        <div class="row">
            ...
            <!-- Grid column -->
            <div  style="width: 100%; color: #ffffff;padding-left: 0px;padding-right: 0px;" class="col-md-6 mt-md-0 mt-3">
                <!-- Content -->
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <!-- Controls -->
                <a style="float: right" class="left carousel-control" href="#myCarousel" data-slide="prev">
                    <span class="glyphicon glyphicon-chevron-left"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a style="float: left" class="right carousel-control" href="#myCarousel" data-slide="next">
