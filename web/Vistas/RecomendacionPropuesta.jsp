<%-- 
    Document   : RecomendacionPropuesta
    Created on : 13/11/2018, 03:28:47 PM
    Author     : Martin
--%>
<%@page import="servicios.DtRecomendacionProp"%>
                        ...
                        <div class="col-md-6 ml-auto mr-auto">
                            <div class="profile" style="width: 157%;margin-left: -27%;">
                                <table id="tabla" class="table table-bordered table-hover formulario">
                                    <thead>
                                    <h2  style=" text-align: center;top: 76px;">Recomendación de propuesta</h2>
                                    ...
                                    <tr>
                                        <th style="color:black" class="active">Posición</th>
                                        <th style="color:black" class="active">Titulo</th>
                                        <th style="color:black" class="active">Puntuacion</th>
                                    ...
                                    <div style="overflow: auto">
                                        <tbody>
                                            <%
                                                List<DtRecomendacionProp> lista = (List<DtRecomendacionProp>) request.getAttribute("listaPropuestas");
                                                int p = 1;
                                                for (int i = 0; i < lista.size(); i++) {
                                                    ...
                                                    out.print("<td><p>" + p + " </p></td>");
                                                    out.print("<td><p>" + lista.get(i).getTitulo() + " </p></td>");
                                                    out.print("<td><p>" + lista.get(i).getPuntaje() + "</p></td>");
